...
function segwidDictionary() {
    ...
    if (kony.os.deviceInfo().name == "iPad" || kony.os.deviceInfo().name == "iPad Simulator") frmSegDictView.segDictView.setDataWithSections(segdata);
...
function multiSelectTab() {
    ...
    if (kony.os.deviceInfo().name == "iPad" || kony.os.deviceInfo().name == "iPad Simulator") frmSegmentFeatures.sbxSegmentFeatureDetails.scrollToWidget(frmSegmentTablet.segMultiSelectData);
}
/*****************************************************************
 *	Name    : singleSelect
 *	Author  : Kony 
...
function refresh(seguiWidget) {
    ...
    if (kony.os.deviceInfo().name == "iPhone" || kony.os.deviceInfo().name == "iPhone Simulator" || kony.os.deviceInfo().name == "iPad") kony.application.showLoadingScreen("loadingscreen", "Loading...", constants.LOADING_SCREEN_POSITION_FULL_SCREEN, true, true, {
