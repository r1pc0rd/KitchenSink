...
function onCaptureFrmOverLayTab(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "android" && kony.os.deviceInfo().name != "iPad" || kony.os.deviceInfo().name == "iPad Simulator") frmCameraFrmOverlay.show();
    kony.application.dismissLoadingScreen();
}
/*****************************************************************
 *	Name    : onCaptureTab
...
function onCapturePrivate(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "iPhone" && kony.os.deviceInfo().name != "iPhone Simulator") frmCamAcsModes.lblFrmCamAccessModes.text = "Second image from left is the captured image in private mode. You can not see the image in image Gallery of the camera .To observe this ,Hide the application and open camera and go to image gallery."
...
function onCaptureinMemory(cameraObj) {
    ...
    if (kony.os.deviceInfo().name != "iPhone" && kony.os.deviceInfo().name != "iPhone Simulator") frmCamAcsModes.lblFrmCamAccessModes.text = "Third image from left is the captured image in inMemory mode. You can not see the image in image Gallery of the camera .To observe this ,Hide the application and open camera and go to image gallery."
