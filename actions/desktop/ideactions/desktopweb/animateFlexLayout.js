...
function resetWidgetPositions() {
    if (kony.os.deviceInfo().name == "android") frmFlex.lblFlexLine.text = "Line";
...
function animateLine() {
    if (kony.os.deviceInfo().name == "WindowsPhone" || kony.os.deviceInfo().name == "Windows8") {
        frmFlex.lblFlexLine.animate(animationObj(280, 0), animationConfig(), {
            "animationEnd": animateBottomPart
        });
    } else {
        frmFlex.lblFlexLine.animate(animationObj(220, 0), animationConfig(), {
            "animationEnd": animateBottomPart
        });
    }
}
...
function animatePhoneNumbers() {
    if (kony.os.deviceInfo().name == "WindowsPhone" || kony.os.deviceInfo().name == "Windows8") {
        ...
        frmFlex.lblFlexPhoneWork.animate(animationObj(240, 12), animationConfig(), {
            "animationEnd": animateLine
        });
    } else {
        frmFlex.lblFlexPhoneHome.animate(animationObj(140, 12), animationConfig(), {});
        frmFlex.lblFlexPhoneWork.animate(animationObj(180, 12), animationConfig(), {
            "animationEnd": animateLine
        });
    }
}
...
function animateFlex() {
    if (kony.os.deviceInfo().name == "WindowsPhone" || kony.os.deviceInfo().name == "Windows8") {
        ...
        frmFlex.lblFlexCompany.animate(animationObj(148, 130), animationConfig(), {
            "animationEnd": animatePhoneNumbers
        });
    } else {
        ...
        frmFlex.lblFlexCompany.animate(animationObj(88, 130), animationConfig(), {
            "animationEnd": animatePhoneNumbers
        });
    }
}