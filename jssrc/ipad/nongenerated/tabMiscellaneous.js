...
function tab_LoadingScreenCenter() {
    if (flag == 0) {
        flag = 1;
        if (kony.os.deviceInfo().name == "iPad" || kony.os.deviceInfo().name == "iPad Simulator" || kony.os.deviceInfo().name == "iPad Simulator") kony.application.showLoadingScreen("loadingscreen", "Loading...", constants.LOADING_SCREEN_POSITION_ONLY_CENTER, true, true, {
