...
function uICategory() {
    ...
    switch (segSelectedIndex) {
        ...
        case 2:
            ...
            break;
        case 3:
            if (kony.os.deviceInfo().name == "iPad" || kony.os.deviceInfo().name == "iPad Simulator") frmIpadSpecificFeatures.show();
            else if (kony.os.deviceInfo().name == "iPhone" || kony.os.deviceInfo().name == "iPhone Simulator" || kony.os.deviceInfo().name == "android" || kony.os.deviceInfo().name == "thinclient" || kony.os.deviceInfo().name == "WindowsPhone") frmFlex.show();
            else alert("Not available in this channel");
            break;
    }
}
/*****************************************************************
